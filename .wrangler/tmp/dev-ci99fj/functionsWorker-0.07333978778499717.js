...
// .wrangler/tmp/pages-Vi31mn/functionsWorker-0.07333978778499717.mjs
...
var onRequest = /* @__PURE__ */ __name2(async (context) => {
  ...
  try {
    ...
    if (!name || !phone || !service) {
      return json({ success: false, message: "Vui l\xF2ng \u0111i\u1EC1n \u0111\u1EA7y \u0111\u1EE7 th\xF4ng tin b\u1EAFt bu\u1ED9c." }, 400);
    }
    if (ts) {
      const delta = Date.now() - Number(ts);
      if (!Number.isFinite(delta) || delta < 1e3) {
        return json({ success: false, message: "Vui l\xF2ng th\u1EED l\u1EA1i sau." }, 429);
      }
    }
    ...
    const subject = "Y\xEAu c\u1EA7u t\u01B0 v\u1EA5n t\u1EEB Datmo.io.vn";
    const contentText = `H\u1ECD t\xEAn: ${name}
S\u1ED1 \u0111i\u1EC7n tho\u1EA1i: ${phone}
D\u1ECBch v\u1EE5: ${service}
N\u1ED9i dung: ${message || "\u2014"}
`;
    ...
    return json({ success: false, message: "C\xF3 l\u1ED7i x\u1EA3y ra." }, 500);
  }
}, "onRequest");
...
// .wrangler/tmp/bundle-liRXeP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-liRXeP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.07333978778499717.js.map
